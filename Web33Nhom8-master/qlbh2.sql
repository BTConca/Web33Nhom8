...
INSERT INTO `categories` VALUES (1,'RƯỢU VANG'),(2,'CHAMPANGES'),(3,'WHISKY'),(4,'COGNAC'),(5,'VODKA');
...
CREATE TABLE `donhang` (
  `ID` int(11) NOT NULL,
  `TenDonHang` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
INSERT INTO `donhang` VALUES (1,'Obama','2018-12-01',50,'Chưa Giao'),(2,'Obama','2018-12-01',50,'Đang Giao'),(3,'Obama','2018-12-01',50,'Hoàn Thành');
...
CREATE TABLE `producers` (
  `ProducerName` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_vietnamese_ci NOT NULL,
...
INSERT INTO `producers` VALUES ('Feudi Salentini S.R.L',1),('Chivas',2),('Label hamston',3);
...
INSERT INTO `subcategories` VALUES (1,1,'Vang Italia'),(1,2,'Vang Chile'),(1,3,'Vang Pháp'),(1,4,'Vang Hungaria'),(1,5,'Vang Austraylia'),(3,1,'Ballantine\'s'),(3,2,'Chivas'),(3,3,'Edradour'),(3,4,'Johnnie Walker'),(3,5,'Glenfarclas'),(3,6,'Tomatin'),(3,7,'Macallan'),(3,8,'Old Malt Cask');
...
INSERT INTO `users` VALUES (1,'1512414','3e0eae1c969e252127ea57c61cdcc11d199c151465ea50661066727103c560d9','sadasd','dsadasdsa','2018-06-21',0);
...
-- Dump completed on 2018-06-27 23:45:30
